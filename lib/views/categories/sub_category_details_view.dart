...
class SubCategoryDetailsView extends StatelessWidget {
  const SubCategoryDetailsView({Key? key, required this.title}) : super(key: key);
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: StreamBuilder<QuerySnapshot>(
              stream: FirestoreServices.getSubCategoryProducts(subCategory: title),
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ProductModel product =
                          ProductModel.fromMap(snapshot.data!.docs[index].data() as Map<String, dynamic>);
                      return Column(
